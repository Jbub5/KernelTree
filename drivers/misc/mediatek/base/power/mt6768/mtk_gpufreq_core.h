...
#define SEG_GPU_DVFS_VOLT0		(94500)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT1		(92000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(89500)		/* mV x 100 */
...
#define SEG_GPU_DVFS_VOLT31		(61150)		/* mV x 100 */
